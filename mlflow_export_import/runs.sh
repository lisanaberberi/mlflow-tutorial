...
read -p "Enter the RUN_ID to export: " RUN_ID
...
# Export run
export-run --run-id $RUN_ID --output-dir $EXPORT_OUTPUT_DIR
...
# Import run
import-run --experiment-name $EXPERIMENT_NAME --input-dir $IMPORT_INPUT_DIR
